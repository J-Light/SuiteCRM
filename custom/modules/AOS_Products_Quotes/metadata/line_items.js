...
function insertLineItems(product,group){
	...
	calculateLine(ln,type, false, true);
...
function insertProductLine(tableid, groupid) {
	...
	f.innerHTML += "<select tabindex='116' name='product_vat[" + prodln + "]' id='product_vat" + prodln + "' onchange='calculateLine(" + prodln + ",\"product_\", false, false);'>" + vat_hidden + "</select>";
	cellno_row1++;
