...
$hook_array['after_save'][] = Array(81, 'generate_crn', 'custom/modules/Accounts/AccountsHook.php', 'AccountsHook', 'generate_crn');
$hook_array['after_save'][] = Array(81, 'updateAddress', 'custom/modules/Accounts/AccountsHook.php', 'AccountsHook', 'updateAddress');
