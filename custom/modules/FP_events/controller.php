...
class FP_eventsController extends SugarController
{
    ...
    /* Start : Aevin */
    public function action_markemailclick()
    {
        global $db;
        ...
        if($entire_list != '1'){
            ...
            foreach($contacts as $contact){
                ...
                $query = 'UPDATE fp_events_contacts_c SET accept_status="Email Click (Interested)" WHERE fp_events_contactsfp_events_ida="'.$event_id.'" AND fp_events_contactscontacts_idb="'.$contact.'"';
                $res = $db->query($query);
                //update Leads query
                $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Email Click (Interested)" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'" AND fp_events_leads_1leads_idb="'.$contact.'"';
                $res = $db->query($query2);
                //update targets query
                $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Email Click (Interested)" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'" AND fp_events_prospects_1prospects_idb="'.$contact.'"';
                $res = $db->query($query3);
            ...
            //update contacts query
            $query = 'UPDATE fp_events_contacts_c SET accept_status="Email Click (Interested)" WHERE fp_events_contactsfp_events_ida="'.$event_id.'"';
            $res = $db->query($query);
            //update Leads query
            $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Email Click (Interested)" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query2);
            //update targets query
            $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Email Click (Interested)" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query3);
        }
    }

    public function action_markinboundwebpage() {
        global $db;
        ...
        if($entire_list != '1'){
            ...
            foreach($contacts as $contact){
                ...
                $query = 'UPDATE fp_events_contacts_c SET accept_status="Inbound LEAP Webpage" WHERE fp_events_contactsfp_events_ida="'.$event_id.'" AND fp_events_contactscontacts_idb="'.$contact.'"';
                $res = $db->query($query);
                //update Leads query
                $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Inbound LEAP Webpage" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'" AND fp_events_leads_1leads_idb="'.$contact.'"';
                $res = $db->query($query2);
                //update targets query
                $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Inbound LEAP Webpage" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'" AND fp_events_prospects_1prospects_idb="'.$contact.'"';
                $res = $db->query($query3);
            ...
            //update contacts query
            $query = 'UPDATE fp_events_contacts_c SET accept_status="Inbound LEAP Webpage" WHERE fp_events_contactsfp_events_ida="'.$event_id.'"';
            $res = $db->query($query);
            //update Leads query
            $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Inbound LEAP Webpage" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query2);
            //update targets query
            $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Inbound LEAP Webpage" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query3);
        }
    }

    public function action_markinboundvendors() {
        global $db;
        ...
        if($entire_list != '1'){
            ...
            foreach($contacts as $contact){
                ...
                $query = 'UPDATE fp_events_contacts_c SET accept_status="Inbound Vendors" WHERE fp_events_contactsfp_events_ida="'.$event_id.'" AND fp_events_contactscontacts_idb="'.$contact.'"';
                $res = $db->query($query);
                //update Leads query
                $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Inbound Vendors" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'" AND fp_events_leads_1leads_idb="'.$contact.'"';
                $res = $db->query($query2);
                //update targets query
                $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Inbound Vendors" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'" AND fp_events_prospects_1prospects_idb="'.$contact.'"';
                $res = $db->query($query3);
            ...
            //update contacts query
            $query = 'UPDATE fp_events_contacts_c SET accept_status="Inbound Vendors" WHERE fp_events_contactsfp_events_ida="'.$event_id.'"';
            $res = $db->query($query);
            //update Leads query
            $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Inbound Vendors" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query2);
            //update targets query
            $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Inbound Vendors" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query3);
        }
    }

    public function action_markinboundemail() {
        global $db;
        ...
        if($entire_list != '1'){
            ...
            foreach($contacts as $contact){
                ...
                $query = 'UPDATE fp_events_contacts_c SET accept_status="Inbound Email" WHERE fp_events_contactsfp_events_ida="'.$event_id.'" AND fp_events_contactscontacts_idb="'.$contact.'"';
                $res = $db->query($query);
                //update Leads query
                $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Inbound Email" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'" AND fp_events_leads_1leads_idb="'.$contact.'"';
                $res = $db->query($query2);
                //update targets query
                $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Inbound Email" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'" AND fp_events_prospects_1prospects_idb="'.$contact.'"';
                $res = $db->query($query3);
            ...
            //update contacts query
            $query = 'UPDATE fp_events_contacts_c SET accept_status="Inbound Email" WHERE fp_events_contactsfp_events_ida="'.$event_id.'"';
            $res = $db->query($query);
            //update Leads query
            $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Inbound Email" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query2);
            //update targets query
            $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Inbound Email" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query3);
        }
    }

    public function action_markinboundcalls() {
        global $db;
        ...
        if($entire_list != '1'){
            ...
            foreach($contacts as $contact){
                ...
                $query = 'UPDATE fp_events_contacts_c SET accept_status="Inbound Calls" WHERE fp_events_contactsfp_events_ida="'.$event_id.'" AND fp_events_contactscontacts_idb="'.$contact.'"';
                $res = $db->query($query);
                //update Leads query
                $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Inbound Calls" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'" AND fp_events_leads_1leads_idb="'.$contact.'"';
                $res = $db->query($query2);
                //update targets query
                $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Inbound Calls" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'" AND fp_events_prospects_1prospects_idb="'.$contact.'"';
                $res = $db->query($query3);
            ...
            //update contacts query
            $query = 'UPDATE fp_events_contacts_c SET accept_status="Inbound Calls" WHERE fp_events_contactsfp_events_ida="'.$event_id.'"';
            $res = $db->query($query);
            //update Leads query
            $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Inbound Calls" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query2);
            //update targets query
            $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Inbound Calls" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query3);
        }
    }

    public function action_markuncertain() {
        global $db;
        ...
        if($entire_list != '1'){
            ...
            foreach($contacts as $contact){
                ...
                $query = 'UPDATE fp_events_contacts_c SET accept_status="Uncertain" WHERE fp_events_contactsfp_events_ida="'.$event_id.'" AND fp_events_contactscontacts_idb="'.$contact.'"';
                $res = $db->query($query);
                //update Leads query
                $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Uncertain" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'" AND fp_events_leads_1leads_idb="'.$contact.'"';
                $res = $db->query($query2);
                //update targets query
                $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Uncertain" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'" AND fp_events_prospects_1prospects_idb="'.$contact.'"';
                $res = $db->query($query3);
            ...
            //update contacts query
            $query = 'UPDATE fp_events_contacts_c SET accept_status="Uncertain" WHERE fp_events_contactsfp_events_ida="'.$event_id.'"';
            $res = $db->query($query);
            //update Leads query
            $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Uncertain" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query2);
            //update targets query
            $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Uncertain" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query3);
        }
    }

    public function action_markcontacted() {
        global $db;
        ...
        if($entire_list != '1'){
            ...
            foreach($contacts as $contact){
                ...
                $query = 'UPDATE fp_events_contacts_c SET accept_status="To Be Contacted" WHERE fp_events_contactsfp_events_ida="'.$event_id.'" AND fp_events_contactscontacts_idb="'.$contact.'"';
                $res = $db->query($query);
                //update Leads query
                $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="To Be Contacted" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'" AND fp_events_leads_1leads_idb="'.$contact.'"';
                $res = $db->query($query2);
                //update targets query
                $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="To Be Contacted" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'" AND fp_events_prospects_1prospects_idb="'.$contact.'"';
                $res = $db->query($query3);
            ...
            //update contacts query
            $query = 'UPDATE fp_events_contacts_c SET accept_status="To Be Contacted" WHERE fp_events_contactsfp_events_ida="'.$event_id.'"';
            $res = $db->query($query);
            //update Leads query
            $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="To Be Contacted" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query2);
            //update targets query
            $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="To Be Contacted" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query3);
        }
    }

    public function action_markinterested() {
        global $db;
        ...
        if($entire_list != '1'){
            ...
            foreach($contacts as $contact){
                ...
                $query = 'UPDATE fp_events_contacts_c SET accept_status="Interested" WHERE fp_events_contactsfp_events_ida="'.$event_id.'" AND fp_events_contactscontacts_idb="'.$contact.'"';
                $res = $db->query($query);
                //update Leads query
                $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Interested" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'" AND fp_events_leads_1leads_idb="'.$contact.'"';
                $res = $db->query($query2);
                //update targets query
                $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Interested" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'" AND fp_events_prospects_1prospects_idb="'.$contact.'"';
                $res = $db->query($query3);
            ...
            //update contacts query
            $query = 'UPDATE fp_events_contacts_c SET accept_status="Interested" WHERE fp_events_contactsfp_events_ida="'.$event_id.'"';
            $res = $db->query($query);
            //update Leads query
            $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Interested" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query2);
            //update targets query
            $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Interested" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query3);
        }
    }

    public function action_markregistered() {
        global $db;
        ...
        if($entire_list != '1'){
            ...
            foreach($contacts as $contact){
                ...
                $query = 'UPDATE fp_events_contacts_c SET accept_status="Registered" WHERE fp_events_contactsfp_events_ida="'.$event_id.'" AND fp_events_contactscontacts_idb="'.$contact.'"';
                $res = $db->query($query);
                //update Leads query
                $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Registered" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'" AND fp_events_leads_1leads_idb="'.$contact.'"';
                $res = $db->query($query2);
                //update targets query
                $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Registered" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'" AND fp_events_prospects_1prospects_idb="'.$contact.'"';
                $res = $db->query($query3);
            ...
            //update contacts query
            $query = 'UPDATE fp_events_contacts_c SET accept_status="Registered" WHERE fp_events_contactsfp_events_ida="'.$event_id.'"';
            $res = $db->query($query);
            //update Leads query
            $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Registered" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query2);
            //update targets query
            $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Registered" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query3);
        }
    }

    public function action_markinterestedunableattend() {
        global $db;
        ...
        if($entire_list != '1'){
            ...
            foreach($contacts as $contact){
                ...
                $query = 'UPDATE fp_events_contacts_c SET accept_status="Interested But Unable to Attend" WHERE fp_events_contactsfp_events_ida="'.$event_id.'" AND fp_events_contactscontacts_idb="'.$contact.'"';
                $res = $db->query($query);
                //update Leads query
                $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Interested But Unable to Attend" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'" AND fp_events_leads_1leads_idb="'.$contact.'"';
                $res = $db->query($query2);
                //update targets query
                $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Interested But Unable to Attend" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'" AND fp_events_prospects_1prospects_idb="'.$contact.'"';
                $res = $db->query($query3);
            ...
            //update contacts query
            $query = 'UPDATE fp_events_contacts_c SET accept_status="Interested But Unable to Attend" WHERE fp_events_contactsfp_events_ida="'.$event_id.'"';
            $res = $db->query($query);
            //update Leads query
            $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Interested But Unable to Attend" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query2);
            //update targets query
            $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Interested But Unable to Attend" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query3);
        }
    }

    public function action_markregisterednotattend() {
        global $db;
        ...
        if($entire_list != '1'){
            ...
            foreach($contacts as $contact){
                ...
                $query = 'UPDATE fp_events_contacts_c SET accept_status="Registered But Didnt Attend" WHERE fp_events_contactsfp_events_ida="'.$event_id.'" AND fp_events_contactscontacts_idb="'.$contact.'"';
                $res = $db->query($query);
                //update Leads query
                $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Registered But Didnt Attend" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'" AND fp_events_leads_1leads_idb="'.$contact.'"';
                $res = $db->query($query2);
                //update targets query
                $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Registered But Didnt Attend" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'" AND fp_events_prospects_1prospects_idb="'.$contact.'"';
                $res = $db->query($query3);
            ...
            //update contacts query
            $query = 'UPDATE fp_events_contacts_c SET accept_status="Registered But Didnt Attend" WHERE fp_events_contactsfp_events_ida="'.$event_id.'"';
            $res = $db->query($query);
            //update Leads query
            $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Registered But Didnt Attend" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query2);
            //update targets query
            $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Registered But Didnt Attend" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query3);
        }
    }

    public function action_markpresenter() {
        global $db;
        ...
        if($entire_list != '1'){
            ...
            foreach($contacts as $contact){
                ...
                $query = 'UPDATE fp_events_contacts_c SET accept_status="Presenter" WHERE fp_events_contactsfp_events_ida="'.$event_id.'" AND fp_events_contactscontacts_idb="'.$contact.'"';
                $res = $db->query($query);
                //update Leads query
                $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Presenter" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'" AND fp_events_leads_1leads_idb="'.$contact.'"';
                $res = $db->query($query2);
                //update targets query
                $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Presenter" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'" AND fp_events_prospects_1prospects_idb="'.$contact.'"';
                $res = $db->query($query3);
            ...
            //update contacts query
            $query = 'UPDATE fp_events_contacts_c SET accept_status="Presenter" WHERE fp_events_contactsfp_events_ida="'.$event_id.'"';
            $res = $db->query($query);
            //update Leads query
            $query2 = 'UPDATE fp_events_leads_1_c SET accept_status="Presenter" WHERE fp_events_leads_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query2);
            //update targets query
            $query3 = 'UPDATE fp_events_prospects_1_c SET accept_status="Presenter" WHERE fp_events_prospects_1fp_events_ida="'.$event_id.'"';
            $res = $db->query($query3);
        }
    }
    /* End : Aevin*/
