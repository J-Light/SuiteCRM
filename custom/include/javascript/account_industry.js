function handle_industry_for_accounts() {
  open_popup("CM6_Industry", 600, 400, "", true, true, {
    "call_back_function": "set_return_and_save_for_industry",
    "form_name": "DetailView",
    "field_to_name_array": {"id": "subpanel_id"},
    "passthru_data": {
      "refresh_page": 0,
      "pop_up_type": "industry"
    }
  }, "MultiSelect", true);
}

function handle_account_for_industries() {
  open_popup("Accounts", 600, 400, "", true, true, {
    "call_back_function": "set_return_and_save_for_account",
    "form_name": "DetailView",
    "field_to_name_array": {"id": "subpanel_id"},
    "passthru_data": {
      "refresh_page": 0,
      "pop_up_type": "accounts"
    }
  }, "MultiSelect", true);
}

function set_return_and_save_for_industry(popup_reply_data) {
  ...
  query_array.push('action=add_to_industry');
...
function set_return_and_save_for_account(popup_reply_data) {
  var form_name = popup_reply_data.form_name;
  var name_to_value_array = popup_reply_data.name_to_value_array;
  var passthru_data = popup_reply_data.passthru_data;
  var select_entire_list = typeof( popup_reply_data.select_entire_list ) == 'undefined' ? 0 : popup_reply_data.select_entire_list;
  ...
  query_array.push('record=' + id);
  query_array.push('isDuplicate=false');
  query_array.push('action=add_to_accounts');
  query_array.push('inline=1');
  query_array.push('select_entire_list=' + select_entire_list);
  if (select_entire_list == 1) {
    query_array.push('current_query_by_page=' + current_query_by_page);
