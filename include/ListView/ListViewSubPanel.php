                        ...
                        if ($usage != 'query_only') {
                            ...
                            if (isset($aItem->field_defs[strtolower($list_field['name'])])) {
                                ...
                                elseif (preg_match("/button/i", $list_field['name'])) {
                                    if ((($list_field['name'] === 'edit_button' && $field_acl['EditView']) || ($list_field['name'] === 'close_button' && $field_acl['EditView']) || ($list_field['name'] === 'remove_button' && $field_acl['Delete']) || (strpos($list_field['name'], '_button') !== false)) && '' != ($_content = $layout_manager->widgetDisplay($list_field))) {
